...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    ...
	    Tabs = __webpack_require__(159),
	    Clock = __webpack_require__(160),
	    Weather = __webpack_require__(161),
	    Autocomplete = __webpack_require__(162);
	
	var tabs = ['Home', 'About', 'Contact'];
	var content = ['This is the home page', 'This is the about page', 'This is the contact page'];
	
	var users = ['Allison', 'Albright', 'Aubrey', 'Brittany', 'Candice', 'Charlotte', 'David', 'Dylan', 'Earl', 'Rick', 'Morty', 'Walter', 'Jessie'];
	
	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(
	    'div',
	    null,
	    React.createElement(Tabs, { items: tabs, content: content }),
	    React.createElement(Clock, null),
	    React.createElement(Weather, null),
	    React.createElement(Autocomplete, { items: users })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Weather = React.createClass({
	  ...
	  getWeather: function (lat, lon) {
	    ...
	    weatherRequest.open('GET', 'http://api.openweathermap.org/data/2.5/weather?lat=' + lat + '&lon=' + lon + '&APPID=' + apiKey, true);
	    ...
	    weatherRequest.onload = function (e) {
	      if (weatherRequest.readyState === 4) {
	        if (weatherRequest.status === 200) {
	          ...
	          that.setWeatherLocation(weatherDescription, weatherTempF, weatherResponse);
	        }
	      }
	    };
	    weatherRequest.send();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactCSSTransitionGroup = __webpack_require__(163);
